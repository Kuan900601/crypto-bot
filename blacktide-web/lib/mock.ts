...
export const SIGNALS: Signal[] = [
  {
    ...
    tps: [
      { level: 1, price: 99400, r: 1.5, weight: 40, hit: false },
      { level: 2, price: 101600, r: 2.5, weight: 35, hit: false },
      { level: 3, price: 103800, r: 3.5, weight: 25, hit: false },
    ],
  },
  {
    ...
    tps: [
      { level: 1, price: 184.7, r: 1.5, weight: 40, hit: true },
      { level: 2, price: 190.8, r: 2.5, weight: 35, hit: false },
      { level: 3, price: 196.9, r: 3.5, weight: 25, hit: false },
    ],
  },
  {
    ...
    tps: [
      { level: 1, price: 1.871, r: 1.5, weight: 40, hit: false },
      { level: 2, price: 1.808, r: 2.5, weight: 35, hit: false },
      { level: 3, price: 1.745, r: 3.5, weight: 25, hit: false },
    ],
  },
  {
    ...
    tps: [
      { level: 1, price: 0.1688, r: 1.5, weight: 40, hit: true },
      { level: 2, price: 0.1745, r: 2.5, weight: 35, hit: true },
      { level: 3, price: 0.1802, r: 3.5, weight: 25, hit: false },
    ],
  },
  {
    ...
    tps: [
      { level: 1, price: 3342, r: 1.5, weight: 40, hit: false },
      { level: 2, price: 3253, r: 2.5, weight: 35, hit: false },
      { level: 3, price: 3164, r: 3.5, weight: 25, hit: false },
    ],
  },
  {
    ...
    tps: [
      { level: 1, price: 2.910, r: 1.5, weight: 40, hit: false },
      { level: 2, price: 2.970, r: 2.5, weight: 35, hit: false },
      { level: 3, price: 3.030, r: 3.5, weight: 25, hit: false },
    ],
  },
];
